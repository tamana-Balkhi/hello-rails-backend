...
Hello Rails Back End is a web application that  Ruby on Rails and provides an api end point to get a random greeting message. This [React Front End](https://github.com/tamana-Balkhi/hello-rreact-frontend) utlizes the json provided by this api.
...
- Returns a random greeting message in a json format
...
```
  git clone https://github.com/amexabee/hello-rails-backend.git
```
